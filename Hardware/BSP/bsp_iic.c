...
static IIC_Status_t HW_IIC_Master_Transmit(
    uint16_t DevAddress,
    uint8_t *pData,
    uint16_t Size,
    uint32_t Timeout)
...
static IIC_Status_t HW_IIC_Master_Receive(
    uint16_t DevAddress,
    uint8_t *pData,
    uint16_t Size,
    uint32_t Timeout)
...
static IIC_Status_t HW_IIC_Mem_Write(
    uint16_t DevAddress,
    uint16_t MemAddress,
    uint8_t *pData,
    uint16_t Size,
...
static IIC_Status_t HW_IIC_Mem_Read(
    uint16_t DevAddress,
    uint16_t MemAddress,
    uint8_t *pData,
    uint16_t Size,
